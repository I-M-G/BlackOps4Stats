...
// let stats = {
//   prestige: {title: 'Prestige', value: 0},
//   level: {title: 'Level', value: 0},
//   totalKills: {title: 'TotalKills', value: 0},
//   totalWins: {title: 'TotalWins', value: 0},
//   eikaRatio: {title: 'EikaRatio', value: 0},
//   kdRatio: {title: 'KDRatio', value: 0}, //Actual kills ratio
//   winLoseRatio: {title: 'WinLoseRatio', value: 0} // I believe, ratio is percent of games won (ex. 78%)
// }
let stats = [
...
let handleData = apiData => {
  ...
  // Fill stats obj
  // stats.prestige.value = parsed.data.stats[0].displayValue;
  // stats.level.value = parsed.data.stats[1].displayValue;
  // stats.totalKills.value = parsed.data.stats[3].displayValue;
  // stats.totalWins.value = parsed.data.stats[16].displayValue;
  // stats.eikaRatio.value = parsed.data.stats[41].displayValue;
  // stats.kdRatio.value = parsed.data.stats[2].displayValue;
  // stats.winLoseRatio.value = winLose; // Converted (ex. 3.41 wins for ever lose)
